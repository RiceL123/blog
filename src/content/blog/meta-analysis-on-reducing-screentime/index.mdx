...
<div style="display: flex; flex-direction: column; width: 100%; align-items: center">
    <div style="display: flex; width: 100%; justify-content: center; gap: 2px">
        <Image alt="normal image" width="500" src={normal} style={{ width: '50%' }}/>
        <Image alt="greyscale image" width="500" src={greyscale} style={{ width: '50%' }}/>
    </div>
...
<div style="display: flex; flex-direction: column; width: 100%; align-items: center">
    <div style="display: flex; width: 100%; justify-content: center; gap: 2px">
        <Image alt="normal image" width="500" src={normal} style={{ width: '33%' }}/>
        <Image alt="inverted image" width="500" src={inverted} style={{ width: '33%' }}/>
        <Image alt="inverted and greyscale image" width="500" src={stacked} style={{ width: '33%' }}/>
    </div>
