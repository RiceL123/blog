...
Overall, this experiment does seem to indicate the validity of moving the charging port away from the bed. Furthermore, other benefits like better sleeping habits were also experienced. However, I was able to conjure some excuses like _"I need my phone as an alarm"_ and _"it'd be weird to use the common area to charge my phone living in a share house"_ despite the success. Remedies like buying a physical alarm clock were deemed as valid[^3] however, I ended up on settling with just putting the charger on the other side of the bedroom giving me an average screen time of around 5.5 hours.
...
<div style="display: flex; flex-direction: column; width: 100%; align-items: center">
  <div style="display: flex; width: 100%; justify-content: center; gap: 2px">
    ...
    />
    <Image
      alt="inverted and greyscale image"
      width="500"
      src={stacked}
      style={{ width: "33%", maxWidth: "300px" }}
    />
...
>
> I see the value in requesting help - but rarely do we see that on media. The only exception may be in the case of humble need. I, for one, have never done something like that and thus all my excuses to show others what I get up to isn't because I wanted to build a digital memoir or portfolio of my life, but to just show others that '_yeah I can compete with you guys in the highlights of life_' which was pretty astounding to become aware of.
>
...
> "_The body should be treated more rigorously, that it may not be disobedient to the mind._" - <cite>Seneca: Letters from a Stoic</cite>
